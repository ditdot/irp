...
<html lang="en">
	<head>
		...
		<title>Home | Information Retrieval Project</title>
				...
				<section class="container">
					...
					<ul class="navigation-list float-right">
						<li class="navigation-item">
							<a class="navigation-link active" href="/irp/">Home</a>
						</li>
						<li class="navigation-item">
						...
						<li class="navigation-item">
							<a class="navigation-link" href="#popover-grid2" data-popover>Vector</a>
			...
			<section class="container">
                <div class="row">
					...
					<div class="column column-30">
						<div class="card">
							<div class="card-img">
								<img src="assets/avatar/boy.png" alt="gambar">
							</div>
							<div class="card-title">
								<h6>KETUA</h6>
								<h5><strong>Ni'am Habibiy Sahid</strong></h5>
								<h6>[ 14.11.0185 ]</h6>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="column column-30">
						<div class="card">
							...
							<div class="card-title">
								<h6>ANGGOTA I</h6>
								<h5><strong>Ikhsan Fauji</strong></h5>
								<h6>[ 14.11.0010 ]</h6>
							</div>
						</div>
					</div>
					<div class="column column-30">
						<div class="card">
							...
							<div class="card-title">
								<h6>ANGGOTA II</h6>
								<h5><strong>Aditiya Pratama</strong></h5>
								<h6>[ 14.11.0145 ]</h6>
							</div>
						</div>
					</div>
					<div class="column column-30">
						<div class="card">
							...
							<div class="card-title">
								<h6>ANGGOTA III</h6>
								<h5><strong>Egi Firmansyah</strong></h5>
								<h6>[ 14.11.0045 ]</h6>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="column column-30">
						<div class="card">
							<div class="card-img">
								<img src="assets/avatar/girl.png" alt="gambar">
							</div>
							<div class="card-title">
								<h6>ANGGOTA IV</h6>
								<h5><strong>Irna Oktaviasari</strong></h5>
								<h6>[ 14.11.0018 ]</h6>
							</div>
						</div>
					</div>
					<div class="column column-30">
						<div class="card">
							...
							<div class="card-title">
								<h6>ANGGOTA V</h6>
								<h5><strong>Aditia Fabiola Anggraheni</strong></h5>
								<h6>[ 14.11.0117 ]</h6>
							</div>
						</div>
					</div>
					<div class="column column-30">
						<div class="card">
							...
							<div class="card-title">
								<h6>ANGGOTA VI</h6>
								<h5><strong>Erip Marliana</strong></h5>
								<h6>[ 14.11.0019 ]</h6>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="column column-30">
						<a class="button" href="/irp/index/create">Create Index</a>
					</div>
					<div class="column column-30">
						<a class="button" href="/irp/weighting">Start Weighting</a>
					</div>
					<div class="column column-30">
						<a class="button" href="/irp/vector/count">Count Vector</a>
					</div>
					<div class="column column-5"></div>
				</div>

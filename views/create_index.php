...
<html lang="en">
	<head>
		...
		<title>Create Index | Information Retrieval Project</title>
	...
	<body>
		...
		<main class="wrapper">
			...
			<nav class="navigation">
				<section class="container">
					...
					<ul class="navigation-list float-right">
						...
						<li class="navigation-item">
							<a class="navigation-link active" href="#popover-grid1" data-popover>Indexing</a>
			...
			<section class="container">
				<blockquote>
                    <p><em>
						Sebanyak <?=$count?> artikel telah terindex menghasilkan <?=$term_count?> term.<br>
						Artikel baru ditambahkan: <?=$new?>.<br>
						Artikel diupdate: <?=$update?>.<br>
						Waktu yang dibutuhkan untuk mengindex: <?=$time?> detik.
					</em></p>
                </blockquote>
            </section>

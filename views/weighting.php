...
<html lang="en">
	<head>
		...
		<title>Weighting | Information Retrieval Project</title>
	...
	<body>
		...
		<main class="wrapper">
			...
			<nav class="navigation">
				<section class="container">
					...
					<ul class="navigation-list float-right">
						...
						<li class="navigation-item">
							<a class="navigation-link active" href="/irp/weighting">Weighting</a>
						</li>
						<li class="navigation-item">
			...
			<section class="container">
				<blockquote>
                    <p><em>
                        Sebanyak <?=$count?> term telah diberikan bobot.<br>
						Waktu yang dibutuhkan untuk pembobotan: <?=$time?> detik.
                    </em></p>
                </blockquote>
            </section>

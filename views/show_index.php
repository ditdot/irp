...
<html lang="en">
	<head>
		...
		<title>Show Index | Information Retrieval Project</title>
	...
	<body>
		...
		<main class="wrapper">
			...
			<section class="container">
				<center>
					<h3>Hasil Penghitungan Index</h3>
				</center>
				<div id="app">
					<table>
					<thead>

...
<html lang="en">
	<head>
		...
		<title>Cache | Information Retrieval Project</title>
		...
		<main class="wrapper">
			...
			<nav class="navigation">
				<section class="container">
					...
					<ul class="navigation-list float-right">
						...
						<li class="navigation-item">
							<a class="navigation-link active" href="/irp/cache">Cache</a>
						</li>
					</ul>
				</section>
			</nav>
			...
			<section class="container">
				...
				<div class="float-right">
					<div class="row">
						<div class="column column-20 cc">
							<a class="button button-small" href="/irp/cache/clear">Clear Cache</a>
						</div>
					</div>
				</div>
